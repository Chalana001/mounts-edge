    ...
    <div class="container mx-auto px-6 text-center">
        <div class="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3">
                <a href="{{ route('contact', ['type' => \App\Models\Enquiry::TYPE_WEDDING]) }}"
                ...
                <a href="https://wa.me/{{ $siteSettings->whatsapp_number }}?text=Hello%20Mounts%20Edge%20Regency!%20I%20would%20like%20to%20plan%20my%20wedding."
                   target="_blank" rel="noopener noreferrer"
                   class="flex items-center gap-3 border border-brand-green text-brand-green hover:border-brand-orange hover:text-brand-orange rounded-none px-8 py-4 text-[10px] tracking-[0.15em] uppercase font-bold transition-colors focus:outline-none cursor-pointer">
